...
from pandasop.db.db_helper import get_dataframe
import pandasop.utils.pandas_helper as helper


def run():
    sql = 'SELECT time, humidity, temperature from wcat01_data ORDER BY time DESC LIMIT 100;'
