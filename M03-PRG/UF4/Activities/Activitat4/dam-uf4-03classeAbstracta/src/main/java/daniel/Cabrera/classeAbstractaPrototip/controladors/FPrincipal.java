...
import daniel.Cabrera.classeAbstractaPrototip.classes.Alerta;
...
import daniel.Cabrera.classeAbstractaPrototip.Main;
...
public class FPrincipal {
  ...
  //  protected Fitxers f = new Fitxers();
    ...
    public void eliminarAutobus() {
        FGeneric("Autobus/FEliminarAutobus.fxml", "Eliminar Autobus");
