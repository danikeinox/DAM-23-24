...
public class HelixController : MonoBehaviour
{
    ...
    public void LoadStage(int stageNumber)
    {
        ...
        // Set the new split ball color
        Color splitColor = allStages[stageNumber].stageSplitColor;
        FindObjectOfType<BallController>().SetSplitColor(splitColor);

        // Reset the helix rotation
        transform.localEulerAngles = startRotation;

        levelsCount = stage.levels.Count;
        ...
        float levelDistance = helixDistance / levelsCount;
