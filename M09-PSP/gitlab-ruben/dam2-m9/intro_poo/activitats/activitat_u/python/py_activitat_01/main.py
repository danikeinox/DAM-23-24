...
def run_main():
    treballadors = [Cap(nom="Lluís el cap", sou=30000.0, incentiu=555.0),
                    Treballador(nom="Luis", sou=20000.0, alta_contracte="15/11/2011"),
                    Treballador(nom="Ana", sou=25000.0, alta_contracte="21/07/2007"),
                    Treballador(nom="Marta", sou=27000.0, alta_contracte="21/07/2007")
                    ]
